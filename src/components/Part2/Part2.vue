...
export default {
    ...
    saveData(payload1, payload2) {
        ...
        if (this.commentData.length == 25) {
            ...
            this.$router.push({ name: 'part-3-intro' })
        }
        else {
            // eslint-disable-next-line 
            console.log(this.commentData.toString())
    ...
    sectionComplete(payload) {
          ...
          this.$storedata.part2eigen[payload] = this.currentEigen;
          this.$storedata.part2lambda.push(this.currentLambda);
          this.$storedata.part2ci.push(this.currentCI);
          this.$storedata.part2cr.push(this.currentCR);
          // eslint-disable-next-line
          console.log(this.$storedata)
          })
